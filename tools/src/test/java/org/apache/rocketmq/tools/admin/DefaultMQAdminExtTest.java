...
public class DefaultMQAdminExtTest {
    private static final String BROKER1_ADDRESS = "127.0.0.1:10911";
    ...
    private static final String BROKER2_ADDRESS = "127.0.0.2:10911";
    ...
    public static void init() throws Exception {
        ...
        brokerAddrs.put(MixAll.MASTER_ID, BROKER1_ADDRESS);
        BrokerData brokerData = new BrokerData();
        brokerData.setCluster(CLUSTER);
        brokerData.setBrokerName(BROKER1_NAME);
        brokerData.setBrokerAddrs(brokerAddrs);
        brokerDatas.add(brokerData);
        brokerDatas.add(new BrokerData(CLUSTER, BROKER2_NAME, (HashMap<Long, String>) Maps.newHashMap(MixAll.MASTER_ID, BROKER2_ADDRESS)));
...
//        when(mQClientAPIImpl.getConsumeStats(anyString(), anyString(), anyString(), anyLong())).thenReturn(consumeStats);
    ...
    public void testFetchAllTopicList() throws RemotingException, MQClientException, InterruptedException {
        ...
        assertThat(topicList.getTopicList().size()).isEqualTo(1);
