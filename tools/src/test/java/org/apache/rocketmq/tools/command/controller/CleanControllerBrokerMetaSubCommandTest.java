...
public class CleanControllerBrokerMetaSubCommandTest {
    ...
    public void testExecuteWithMalformedBrokerControllerIds() throws Exception {
        CleanControllerBrokerMetaSubCommand cmd = new CleanControllerBrokerMetaSubCommand();
