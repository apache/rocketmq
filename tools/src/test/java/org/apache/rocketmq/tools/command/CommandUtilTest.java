...
public class CommandUtilTest {
    ...
    private String masterAddr = "1.0.0.0:10911";
    private String slaveBrokerOneAddr = "1.0.0.1:10911";
    private String slaveBrokerTwoAddr = "1.0.0.2:10911";
    ...
    public void setup() throws MQClientException, NoSuchFieldException, IllegalAccessException, InterruptedException, MQBrokerException, RemotingTimeoutException, RemotingSendRequestException, RemotingConnectException {
        ...
        //put slave broker
        brokerAddrs.put(1L, slaveBrokerOneAddr);
        brokerAddrs.put(2L, slaveBrokerTwoAddr);
    ...
    public void testFetchMasterAndSlaveDistinguish() throws InterruptedException, MQBrokerException, RemotingTimeoutException, RemotingSendRequestException, RemotingConnectException {
        ...
        assertThat(result.get(masterAddr).size()).isEqualTo(2);
        assertThat(result.get(masterAddr)).containsExactlyInAnyOrder(slaveBrokerOneAddr, slaveBrokerTwoAddr);
    }
    ...
    public void testFetchMasterAddrByClusterName() throws InterruptedException, MQBrokerException, RemotingTimeoutException, RemotingSendRequestException, RemotingConnectException {
        ...
        assertThat(result.size()).isEqualTo(1);
        assertThat(result).containsExactly(masterAddr);
    }
    ...
    @Test
    public void testFetchMasterAndSlaveAddr() throws Exception {
        Set<String> result = CommandUtil.fetchMasterAndSlaveAddrByClusterName(defaultMQAdminExtImpl, "default-cluster");
        assertThat(result.size()).isEqualTo(3);
        assertThat(result).containsExactlyInAnyOrder(masterAddr, slaveBrokerOneAddr, slaveBrokerTwoAddr);
    }
}