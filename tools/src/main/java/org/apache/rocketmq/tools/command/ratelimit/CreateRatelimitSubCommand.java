...
public class CreateRatelimitSubCommand implements SubCommand {
    ...
    public String commandDesc() {
        return "Create ratelimit rule to cluster.";
    }
    ...
    public Options buildCommandlineOptions(Options options) {
        ...
        Option opt = new Option("c", "clusterName", true, "create ratelimit rule to which cluster");
        optionGroup.addOption(opt);

        opt = new Option("b", "brokerAddr", true, "create ratelimit rule to which broker");
        optionGroup.addOption(opt);

        optionGroup.setRequired(true);
        options.addOptionGroup(optionGroup);

        opt = new Option("r", "ratelimitName", true, "the name of ratelimit rule to create.");
        ...
        opt = new Option("e", "entityName", true, "the entityName of ratelimit rule to create");
        opt.setRequired(true);
        options.addOption(opt);
        ...
        opt = new Option("p", "putTps", true, "the produce TPS of ratelimit rule to create");
        opt.setRequired(true);
        options.addOption(opt);

        opt = new Option("g", "getTps", true, "the consume TPS of ratelimit rule to create");
        opt.setRequired(true);
        options.addOption(opt);
    ...
    public void execute(CommandLine commandLine, Options options,
        ...
        try {
            ...
            if (commandLine.hasOption('b')) {
                ...
                defaultMQAdminExt.createRatelimit(addr, new RatelimitInfo(name, entityType, entityName, matcherType, putTps, getTps));

                System.out.printf("create ratelimit rule to %s success.%n", addr);
                return;
