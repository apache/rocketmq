...
public class DefaultMQAdminExt extends ClientConfig implements MQAdminExt {
    ...
    @Override
    public ProducerConnectionAll examineProducerConnectionAllInfo(String producerGroup, String topic)
            throws RemotingException, MQClientException, InterruptedException, MQBrokerException {
        return defaultMQAdminExtImpl.examineProducerConnectionAllInfo(producerGroup, topic);
    }
