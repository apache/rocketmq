...
public interface MQAdminExt extends MQAdmin {
    ...
    TopicConfig examineTopicConfig(final String addr, final String topic) throws RemotingSendRequestException, RemotingConnectException, RemotingTimeoutException, MQBrokerException, InterruptedException;
