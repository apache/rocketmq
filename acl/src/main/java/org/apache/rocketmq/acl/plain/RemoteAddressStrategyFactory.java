    ...
    public RemoteAddressStrategy getRemoteAddressStrategy(String remoteAddr) {
        ...
        if (remoteAddr.endsWith("}")) {
            if (AclUtils.isColon(remoteAddr)) {
                ...
                return new MultipleRemoteAddressStrategy(AclUtils.getAddressStrArray(remoteAddr, last));
            } else {
                String[] strArray = StringUtils.split(remoteAddr, ".");
                ...
                return new MultipleRemoteAddressStrategy(AclUtils.getAddressStrArray(remoteAddr, four));
            }
