...
public class MessageStoreConfig {
    ...
    private String customDelayMsgTopic = "CUSTOM_DelayMsg_TOPIC_XXXX";
    ...
    public String getCustomDelayMsgTopic() {
        return customDelayMsgTopic;
    }

    public void setCustomDelayMsgTopic(String customDelayMsgTopic) {
        this.customDelayMsgTopic = customDelayMsgTopic;
    }
