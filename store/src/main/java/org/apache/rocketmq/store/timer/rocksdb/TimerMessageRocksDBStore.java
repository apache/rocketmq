...
public class TimerMessageRocksDBStore {
    ...
    public TimerMessageRocksDBStore(final MessageStore messageStore, final TimerMetrics timerMetrics, final BrokerStatsManager brokerStatsManager) {
        ...
        public void run() {
            ...
            while (!this.isStopped()) {
                try {
                    ...
                    logError.error("TimerMessageRocksDBStore error occurred in: {}, error: {}", getServiceName(), e.getMessage());
                }
            }
            ...
            try {
                ...
                while (iterator.hasNext()) {
                    ...
                    try {
                        ...
                        readOffset.incrementAndGet();
                        DefaultStoreMetricsManager.timerMessageSetLatency.record((delayedTime - msgExt.getBornTimestamp()) / 1000, DefaultStoreMetricsManager.newAttributesBuilder().put(DefaultStoreMetricsConstant.LABEL_TOPIC, msgExt.getProperty(MessageConst.PROPERTY_REAL_TOPIC)).build());
                    } catch (Exception e) {
