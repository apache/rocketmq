...
public class DefaultMessageStoreIPV6Test {
...
//        BornHost = new InetSocketAddress(InetAddress.getByName("127.0.0.1"), 0);
        StoreHost = new InetSocketAddress(InetAddress.getByName("::1"), 8123);
        BornHost = new InetSocketAddress(InetAddress.getByName("2408:4004:180:8100:3faa:1dde:2b3f:898a"), 0);
    ...
    private MessageExtBrokerInner buildMessage(byte[] messageBody, String topic) {
        ...
        int sysFlag = 0;
        sysFlag = sysFlag | MessageSysFlag.STOREHOSTADDRESS_V6_FLAG;
        sysFlag = sysFlag | MessageSysFlag.BORNHOST_V6_FLAG;
    ...
    private void damageCommitlog(long offset) throws Exception {
        ...
        int topicLenIndex = (int) offset + 108 + bodyLen + 4;
