...
public class DefaultClientConfiguration implements ClientConfiguration {
    ...
    public static DefaultClientConfigurationBuilder newBuilder() {
        return new DefaultClientConfigurationBuilder();
    }

    public DefaultClientConfiguration(String endpoints, SessionCredentialsProvider sessionCredentialsProvider,
