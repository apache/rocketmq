...
public class TransationStatsInfo {
    ...
    public TransationStatsInfo(String cliHostName,
    ...
    public boolean isNull() {
        return !((beginCount.get()+commitOneCount.get()+commitTwoCount.get()+forgetCount.get()+rollbackCount.get()+recoverCount.get()+endCount.get()+prepareCount.get())>0);
    }
    public void dispose() {
        beginCount.set(beginCount.get()-commitOneCount.get()-commitTwoCount.get()-forgetCount.get()-rollbackCount.get()-recoverCount.get()-endCount.get()-prepareCount.get());
