...
public class PutStatsMoniter {
    ...
    public void append(String topic, String partition, String cliHostName, long succesCount, long faileCount,
            long timeoutCount, long excTime, long msgSize) {
        PutStatsInfor putStatsInfor = putStatsInfors.get(topic + partition + cliHostName);
        if (null == putStatsInfor) {
            putStatsInfor =
                    new PutStatsInfor(topic, partition, cliHostName, succesCount, faileCount, timeoutCount,
                        excTime, msgSize);
            ...
            putStatsInfor.getMsgSizeSum().addAndGet(msgSize);
        }
