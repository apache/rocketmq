...
public class GetMissStatsMoniter {
    ...
    private final ConcurrentHashMap<String/* topic,partition,cliHostName,group */, GetMissStatsInfo> getMissStatsInfos =
            new ConcurrentHashMap<String, GetMissStatsInfo>();
