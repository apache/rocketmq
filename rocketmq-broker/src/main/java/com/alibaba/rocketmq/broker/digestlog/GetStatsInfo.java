...
public class GetStatsInfo {
    ...
    public GetStatsInfo(String topic, String partition, String cliHostName, String group, long succesCount,
    ...
    public boolean isNull() {
        return !((succesCount.get() + faileCount.get() + timeoutCount.get() + excTime.get() + msgSizeSum
            .get()) > 0);
    }
