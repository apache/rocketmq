...
/**
 * normal pop comsumer example
 */
public class NormalPopConsumer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        consumer.setGrayTag(false);
        consumer.registerMessageListener(new MessageListenerConcurrently() {
            @Override
            public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs, ConsumeConcurrentlyContext context) {
                System.out.printf("%s NormalPopConsumer Receive New Messages: %s %n", Thread.currentThread().getName(), msgs);
    ...
    private static void switchPop() throws Exception {
        ...
        for (BrokerData brokerData : brokerDatas) {
            ...
            for (String brokerAddr : brokerAddrs) {
                mqAdminExt.setMessageRequestMode(brokerAddr, TOPIC, CONSUMER_GROUP, MessageRequestMode.POP, 8, 3000);
            }
        }
    }
