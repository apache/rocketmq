 ...
 */
package org.apache.rocketmq.store.tiered.metrics;
...
import org.apache.rocketmq.store.tiered.TieredMessageFetcher;
import org.apache.rocketmq.store.tiered.common.MessageCacheKey;
...
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.COUNTER_CACHE_ACCESS;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.COUNTER_CACHE_HIT;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.COUNTER_GET_MESSAGE_FALLBACK_TOTAL;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.COUNTER_MESSAGES_DISPATCH_TOTAL;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.COUNTER_MESSAGES_OUT_TOTAL;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.GAUGE_CACHE_BYTES;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.GAUGE_CACHE_COUNT;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.GAUGE_DISPATCH_BEHIND;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.GAUGE_DISPATCH_LATENCY;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.GAUGE_STORAGE_MESSAGE_RESERVE_TIME;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.HISTOGRAM_API_LATENCY;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.HISTOGRAM_DOWNLOAD_BYTES;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.HISTOGRAM_PROVIDER_RPC_LATENCY;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.HISTOGRAM_UPLOAD_BYTES;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.LABEL_FILE_TYPE;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.LABEL_QUEUE;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.LABEL_TOPIC;
import static org.apache.rocketmq.store.tiered.metrics.TieredStoreMetricsConstant.STORAGE_MEDIUM_BLOB;
...
public class TieredStoreMetricsManager {
    ...
    public static List<Pair<InstrumentSelector, View>> getMetricsView() {
        ...
        View bufferSizeView = View.builder()
            .setAggregation(Aggregation.explicitBucketHistogram(Arrays.asList(1024d, 10d * 1024, 100d * 1024, 1024d * 1024, 10d * 1024 * 1024, 32d * 1024 * 1024, 50d * 1024 * 1024, 100d * 1024 * 1024)))
