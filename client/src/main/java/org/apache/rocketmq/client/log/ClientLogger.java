...
public class ClientLogger {
    ...
    /**
     * Creation of logging appender involves of opening file and starting a dedicated flushing thread. To make code
     * GraalVM friendly, we would better delay this creation to the moment it will actually be used.
     */
