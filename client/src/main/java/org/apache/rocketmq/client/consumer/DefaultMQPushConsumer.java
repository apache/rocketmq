...
public class DefaultMQPushConsumer extends ClientConfig implements MQPushConsumer {
    ...
    /**
     * Max consumer thread number 消费线程最大线程数，因为消费线程池用的是无界队列，所以这个参数用不上，原因请参考线程池原理
     */
    ...
    /**
     * Batch pull size 从broker端拉取的数量
     */
    private int pullBatchSize = 32;

    /**
     * Whether update subscription relationship when every pull 是否每次拉取之后都跟新订阅关系
     */
