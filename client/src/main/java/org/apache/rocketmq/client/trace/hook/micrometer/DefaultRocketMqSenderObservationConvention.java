...
public class DefaultRocketMqSenderObservationConvention extends AbstractRocketMqObservationConvention implements RocketMqSenderObservationConvention {
     ...
     */
    public static final DefaultRocketMqSenderObservationConvention INSTANCE = new DefaultRocketMqSenderObservationConvention();
    ...
    public KeyValues getHighCardinalityKeyValues(RocketMqSenderContext context) {
        // TODO: Is this the proper group?
        return KeyValues.of(HighCardinalityTags.MESSAGING_ROCKETMQ_MESSAGE_GROUP.withValue(context.getSendMessageContext().getProducerGroup()))
                .and(getHighCardinalityKeyValues(context.getSendMessageContext().getMessage(), context.getSendMessageContext().getProducerGroup(), context.getSendMessageContext().getBrokerAddr(), context.getSendMessageContext().getNamespace()));
    }
