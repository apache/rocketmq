...
public class AllocateMachineRoomNearByTest {
    ...
    @Test
    public void test2() {
        testWhenConsumerIDCIsMore(5,1,10, 10);
        testWhenConsumerIDCIsMore(5,1,10, 5);
        testWhenConsumerIDCIsMore(5,1,10, 20);
        testWhenConsumerIDCIsMore(5,1,10, 0);
    }

    @Test
    public void test3() {
        testWhenConsumerIDCIsLess(5,2,10, 10);
        testWhenConsumerIDCIsLess(5,2,10, 5);
        testWhenConsumerIDCIsLess(5,2,10, 20);
        testWhenConsumerIDCIsLess(5,2,10, 0);
    }
    ...
    public void testRun10RandomCase() {
        for (int i = 0; i < 10; i++) {
            ...
            if (brokerIDCSize == consumerIDCSize) {
                ...
                testWhenConsumerIDCIsLess(brokerIDCSize,brokerIDCSize - consumerIDCSize, queueSize, consumerSize);
            } else {
                testWhenConsumerIDCIsMore(brokerIDCSize, consumerIDCSize - brokerIDCSize, queueSize, consumerSize);
            }
        }
    }
    ...
    public void testWhenConsumerIDCIsMore(int brokerIDCSize, int consumerMore, int queueSize, int consumerSize) {
    ...
    public void testWhenConsumerIDCIsLess(int brokerIDCSize, int consumerIDCLess, int queueSize, int consumerSize) {
