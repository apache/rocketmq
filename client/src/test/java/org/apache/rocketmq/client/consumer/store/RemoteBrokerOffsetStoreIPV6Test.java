...
public class RemoteBrokerOffsetStoreIPV6Test {
    @Mock
    ...
    public void init() {
        ...
        when(mQClientFactory.findBrokerAddressInAdmin(brokerName)).thenReturn(new FindBrokerResult("1050:0000:0000:0000:0005:0600:300c:326b", false));
