...
public class DefaultMQPullConsumerIPV6Test {
    @Spy
    ...
    public void init() throws Exception {
        ...
        pullConsumer.setNamesrvAddr("1050:0000:0000:0000:0005:0600:300c:326b:9876");
        pullConsumer.start();
        ...
        when(mQClientFactory.findBrokerAddressInSubscribe(anyString(), anyLong(), anyBoolean())).thenReturn(new FindBrokerResult("1050:0000:0000:0000:0005:0600:300c:326b:10911", false));
    }
