    ...
    public void testInit() throws Exception{
		...
		MessageQueueListener listener = new MessageQueueListener(){
			...
			public void messageQueueChanged(String topic,
					List<MessageQueue> mqAll, List<MessageQueue> mqDivided) {
...
//	@Test
//	public void testConsumerMsg() throws MQClientException, RemotingException, MQBrokerException, InterruptedException{
