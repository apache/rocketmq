...
public class BaseConf {
    ...
    public static RMQNormalProducer getProducer(String nsAddr, String topic, String producerGroup,
        String instanceName) {
        RMQNormalProducer producer = new RMQNormalProducer(nsAddr, topic, producerGroup,
            instanceName);
        if (debug) {
            producer.setDebug();
        }
