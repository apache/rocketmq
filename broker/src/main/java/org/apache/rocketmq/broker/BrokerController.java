        ...
        if (result) {
            try {
                ...
                if (messageStoreConfig.isEnableDLegerCommitLog()) {
                    ...
                    messageStoreConfig.setStorePathCommitLog(((DLedgerCommitLog) ((DefaultMessageStore) messageStore).getCommitLog()).getdLedgerServer().getdLedgerConfig().getDataStorePath());
                }
