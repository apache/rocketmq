...
public class ReceiveMessageReplyProcessor extends AbstractSendMessageProcessor {
    private static final Logger log = LoggerFactory.getLogger(LoggerName.BROKER_LOGGER_NAME);

    public ReceiveMessageReplyProcessor(final BrokerController brokerController) {
