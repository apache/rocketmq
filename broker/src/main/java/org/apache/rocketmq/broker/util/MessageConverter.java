...
public class MessageConverter {
    ...
    public static MessageExtBrokerInner convertCustomDelayMsg2NormalMsg(MessageExt msgExt) {
        ...
        MessageAccessor.clearProperty(msgExt, MessageConst.PROPERTY_START_DELIVER_TIME);
