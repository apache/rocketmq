...
import org.apache.rocketmq.controller.dledger.event.read.GetNeedReElectBrokerSetsEvent;
import org.apache.rocketmq.controller.dledger.event.read.GetNeedReElectBrokerSetsResult;
...
import org.apache.rocketmq.controller.dledger.event.read.ReadEventType;
...
import org.apache.rocketmq.controller.dledger.event.write.WriteEventType;
...
public class ReplicasManager {
    ...
    private EventResponse<AlterSyncStateSetResult> dealAlterSyncStateSet(final AlterSyncStateSetEvent event) {
        ...
        final AlterSyncStateSetResult result = new AlterSyncStateSetResult();
        resp.setResponseResult(result);
        if (!isContainsBroker(brokerName)) {
        ...
        // Update syncStateSet
        syncStateInfo.updateSyncStateSetInfo(newSyncStateSet);
        result.setNewSyncStateSet(new SyncStateSet(newSyncStateSet, syncStateInfo.getSyncStateSetEpoch()));
        resp.setResponseResult(result);
        return resp;
    }
