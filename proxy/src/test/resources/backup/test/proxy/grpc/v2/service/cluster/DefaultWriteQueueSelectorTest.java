...
public class DefaultWriteQueueSelectorTest extends BaseServiceTest {
    ...
    public void beforeEach() throws Throwable {
        ...
        when(topicRouteService.selectOneWriteQueueByKey(anyString(), anyString()))
            .thenReturn(queue);

        queue = new SelectableMessageQueue(
            new MessageQueue("topic", "selectNormalQueue", 0),
            "selectNormalQueueAddr");
        when(topicRouteService.selectOneWriteQueue(anyString(), isNull()))
            .thenReturn(queue);
    }
    ...
    public void selectWithShardingKey() {
        SendMessageRequest request = SendMessageRequest.newBuilder()
            .addMessages(Message.newBuilder()
                ...
                .build())
            .build();
        WriteQueueSelector queueSelector = new DefaultWriteQueueSelector(this.topicRouteService);
