...
//
//    public ConsumerService(ServiceManager serviceManager, GrpcClientManager grpcClientManager) {
//        super(serviceManager);
//        this.readConsumer = serviceManager.getForwardReadConsumer();
//        this.writeConsumer = serviceManager.getForwardWriteConsumer();
//        this.producer = serviceManager.getForwardProducer();
//        this.grpcClientManager = grpcClientManager;
//
//        this.readQueueSelector = new DefaultReadQueueSelector(serviceManager.getTopicRouteService());
...
//                producer, writeConsumer, grpcClientManager, serviceManager.getTopicRouteService())
//        );
//    }
//
