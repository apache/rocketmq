...
//    }
//
//    public static String getBrokerAddr(Context ctx, TopicRouteService topicRouteService, String brokerName) throws Exception {
//        if (StringUtils.isBlank(brokerName)) {
//            throw new ProxyException(Code.UNRECOGNIZED, "broker name is empty");
//        }
//        String addr = topicRouteService.getBrokerAddr(brokerName);
...
//        return getBrokerAddr(ctx, this.serviceManager.getTopicRouteService(), brokerName);
//    }
//
