...
//
//    public DefaultWriteQueueSelector(TopicRouteService topicRouteService) {
...
//        return this.topicRouteService.selectOneWriteQueue(topic, null);
//    }
//
//    protected SelectableMessageQueue selectOrderQueue(String topic, String shardingKey) throws Exception {
//        return this.topicRouteService.selectOneWriteQueueByKey(topic, shardingKey);
//    }
//}
