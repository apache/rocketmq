...
public class AuthenticationSubjectPipelineTest {

    @Test
    public void executeStoresUserSubjectFromAuthorizationAkHeader() {
    ...
    public void executeLeavesSubjectUnsetWhenAuthorizationAkHeaderIsMissing() {
        ...
        new AuthenticationSubjectPipeline().execute(
            context,
            new Metadata(),
            QueryRouteRequest.getDefaultInstance()
        );
