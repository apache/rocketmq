...
public class GrpcConverter {
    ...
    public static EndTransactionRequestHeader buildEndTransactionRequestHeader(EndTransactionRequest request,
        ...
        try {
            ...
            throw new ProxyException(Code.INVALID_TRANSACTION_ID, "Parse transaction id failed", e);
        }
    ...
    public static Map<String, String> buildMessageProperty(Message message, String producerGroup) {
        ...
        for (String key : userProperties.keySet()) {
            if (MessageConst.STRING_HASH_SET.contains(key)) {
                throw new ProxyException(Code.ILLEGAL_MESSAGE_PROPERTY_KEY, "property is used by system: " + key);
            }
        }
        ...
        if ("".equals(messageId)) {
            throw new ProxyException(Code.ILLEGAL_MESSAGE_ID, "message id is empty");
        }
    ...
    public static SubscriptionData buildSubscriptionData(String topicName, FilterExpression filterExpression) {
        ...
        try {
            ...
            throw new ProxyException(Code.ILLEGAL_FILTER_EXPRESSION, "expression format is not correct", e);
        }
    }
