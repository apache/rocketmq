...
public class GrpcConverterV2 {
    ...
    public static PopMessageRequestHeader buildPopMessageRequestHeader(ReceiveMessageRequest request, long pollTime) {
        ...
        String groupName = GrpcConverterV2.wrapResourceWithNamespace(group);
        MessageQueue messageQueue = request.getMessageQueue();
        ...
        String expressionType = GrpcConverterV2.buildExpressionType(filterExpression.getType());
    ...
    public static EndTransactionRequestHeader buildEndTransactionRequestHeader(EndTransactionRequest request,
        ...
        try {
            ...
            throw new ProxyExceptionV2(Code.INVALID_TRANSACTION_ID, "Parse transaction id failed", e);
        }
        ...
        int commitOrRollback = GrpcConverterV2.buildTransactionCommitOrRollback(request.getResolution());
    ...
    public static PullMessageRequestHeader buildPullMessageRequestHeader(PullMessageRequest request,
        ...
        String expressionType = GrpcConverterV2.buildExpressionType(request.getFilterExpression().getType());
    ...
    public static Map<String, String> buildMessageProperty(Message message, String producerGroup) {
        ...
        for (String key : userProperties.keySet()) {
            if (MessageConst.STRING_HASH_SET.contains(key)) {
                throw new ProxyExceptionV2(Code.ILLEGAL_MESSAGE_PROPERTY_KEY, "property is used by system: " + key);
            }
        }
        ...
        if ("".equals(messageId)) {
            throw new ProxyExceptionV2(Code.ILLEGAL_MESSAGE_ID, "message id is empty");
        }
    ...
    public static Set<SubscriptionData> buildSubscriptionDataSet(List<SubscriptionEntry> subscriptionEntryList) {
        ...
        for (SubscriptionEntry sub : subscriptionEntryList) {
            String topicName = GrpcConverterV2.wrapResourceWithNamespace(sub.getTopic());
    ...
    public static SubscriptionData buildSubscriptionData(String topicName, FilterExpression filterExpression) {
        ...
        try {
            ...
            throw new ProxyExceptionV2(Code.ILLEGAL_FILTER_EXPRESSION, "expression format is not correct", e);
        }
    }
