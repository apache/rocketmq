...
public class RemotingProtocolServerBuilder extends ProxyServerFactoryBase {

    @Override
    protected ProxyServerBase build() {
        return new RemotingProtocolServer(initializer.getMessagingProcessor(), validators);
    }
