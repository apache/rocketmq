...
public class DefaultReceiveMessageResponseStreamWriter extends ReceiveMessageResponseStreamWriter {
    ...
    @Override
    public void write(Context ctx, ReceiveMessageRequest request, PopResult result) {
    ...
    protected static class ReceiveMessageResponseStreamObserver implements StreamObserver<ReceiveMessageResponse> {
