...
public class DefaultNackMessageResponseConverter implements ParameterConverter<AckResult, NackMessageResponse> {

    @Override
    public NackMessageResponse convert(Context ctx, AckResult ackResult) throws Throwable {
