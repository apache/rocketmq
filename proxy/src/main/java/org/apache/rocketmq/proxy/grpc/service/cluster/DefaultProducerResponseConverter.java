...
public class DefaultProducerResponseConverter implements ParameterConverter<SendResult, SendMessageResponse> {

    @Override
    public SendMessageResponse convert(Context ctx, SendResult sendResult) {
