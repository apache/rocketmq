...
# JVM Configuration
#===========================================================================================
JAVA_OPT="${JAVA_OPT} -server -Xms6g -Xmx6g -Xmn4g -XX:PermSize=128m -XX:MaxPermSize=320m"
JAVA_OPT="${JAVA_OPT} -XX:+UseG1GC -XX:G1ReservePercent=10 -XX:SoftRefLRUPolicyMSPerMB=0 -XX:SurvivorRatio=8 -XX:+DisableExplicitGC"
